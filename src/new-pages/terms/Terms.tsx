          ...
          <div className="terms-content-wrapper">
            ...
            <div className="terms-grid">
              ...
              <div className="terms-column">
                ...
                <div className="terms-section">
                  ...
                  <div className="section-content">
                    <ul className="bullet-list">
                      <li>Parking Location: <a target="_blank" rel="noopener noreferrer" href="https://maps.app.goo.gl/jrg6Fv8oqXt4NUF7A">Sri Lanka Exhibition & Convention Centre (SLECC) Card Park.</a></li>
                      <li>
                        Shuttle Service:
                        <ul>
                      ...
                      <li>Attendees will travel through own transport should stop at <a target="_blank" rel="noopener noreferrer" href="https://maps.app.goo.gl/cPcKjFmtEuAg9idS6">Jln Pandan Junction and walk through to the venue entrance</a></li>
                ...
                <div className="terms-section">
                  <header className="section-title" aria-label="section heading">Organizers&apos; Rights</header>
                  <div className="section-content">
                    <ul className="bullet-list">
                      <li>
                    ...
                    <p>
                      <strong>
                        Official <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/kuweni.concert?igsh=YXJkaHZuMmk3ajZl">Instagram</a> / <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/share/1B1V4LBMZq/">Facebook</a> page — Yogeshwari
                      </strong>
                    </p>
                  </div>
                </div>
