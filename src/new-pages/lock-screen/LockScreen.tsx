...
const LockScreen: FC<Props> = ({ milliseconds }) => {
  ...
  // System logs as plain paragraphs
  const systemLogs = [
    ...
    <React.Fragment>
      ...
      <div className="lock-header">
        ...
        <div className="lock-header-right">
          <div className="lock-timestamp" aria-live="polite">
            {timestamp}
          </div>
        </div>
      </div>
        ...
        <div className="lock-screen-layout">
          ...
          <div className="lock-screen-logs-container">
            <div className="lock-screen-logs-header">
              <Marquee
                className="system-logs-marquee"
                speed={50}
                gradient={false}
              >
                <span className="system-logs-text">
                  ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★
                  SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM
                  LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★
                  SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM LOGS ★ SYSTEM
                  LOGS ★
                </span>
              </Marquee>
            ...
            <div className="lock-screen-logs-content">
              {systemLogs.map((paragraph, index) => (
