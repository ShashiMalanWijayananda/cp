...
const ZoneView: FC = () => {
  ...
  const [
    enqueue,
    { loading: enqueueLoading, data: enqueueData, error: enqueueError },
          ...
          <div className="zone-layout-container">
            ...
            {sortedZones.find((zone) => zone.zoneId === 'zoneA') && (
              <div
                ...
                onClick={() => {
                  const zoneA = sortedZones.find(
                    (zone) => zone.zoneId === 'zoneA'
                  );
            ...
            {sortedZones.find((zone) => zone.zoneId === 'zoneZ') && (
              <div
                ...
                onClick={() => {
                  const zoneZ = sortedZones.find(
                    (zone) => zone.zoneId === 'zoneZ'
                  );
