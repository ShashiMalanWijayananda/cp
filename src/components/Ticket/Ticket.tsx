            ...
            <div className="ticket-wrapper">
                {!isShared ? (
                    <div className="ticket-action">
                        <div className="action-group" onClick={() => ticket && onShare && onShare(ticket)} role="button"
                    ...
                    <div className="ticket-action">
                        <div className="action-group" onClick={() => ticket?.id && onDownload && onDownload(ticket.id)} role="button" aria-label="Download ticket">
                ...
                <div className="ticket-relative" >
                    {!isShared && (
                        <div className="ticket-overlay" onClick={() => ticket && onShare && onShare(ticket)} aria-hidden="true"></div>
                    )}

                    <div
                        ref={(el) => ticketRefs && ticketRefs.current && (ticketRefs.current[index || 0] = el)}
                        className="submarine-theme"
                    >
                        <div className="ticket">
                            <div className="ticket-header-section">
                                <h1 className="concert-name">{ticket?.event?.eventName?.toUpperCase() || "ARTIST NAME"}</h1>
                            ...
                            <div className="ticket-graphics">
                                <img src={ticket?.qrData} className={"qr-area"} alt="QR Code"/>
                            ...
                            <div className="agent-section">
                                ...
                                <div className="agent-name">{ticket?.assigner?.nic || "ATTENDEE"}</div>

                                <div className="access-details">
                                    <div className="access-zone-label">ACCESS ZONE:</div>
                                    <div className="zone-designation">ZONE {ticket?.zoneId || "A"}</div>
                            ...
                            <div className="ticket-footer">
                                <div className="event-details">
                                    <div className="detail-item">
                                        ...
                                        {ticket?.event?.eventDate || "N/A"}
                                    </div>
                                    <div className="detail-item">
                                        <span className="detail-label">Time:</span>{" "}
                                        {ticket?.event?.eventTime || "N/A"}
                                    </div>
                                    <div className="detail-item">
